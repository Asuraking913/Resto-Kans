                ...
                <ul className='flex flex-col gap-[2px]'>
                    <li>
                        <p className='w-full poppins p-[1.5px] bg-[--nav] pl-[10px] border-b-[1.5px] border-[--black] rounded-t-[4px]'>
                            ...
                            <input ref={resetRef} onChange={(e) => setProductName(e.target.value)} className='block w-full p-[4px] bg-transparent outline-none focus:pt-[10px] duration-[0.5s]' type="text" required maxLength={30} name="name" id="name" />
                        </p>
                    </li>   
                    <li>
                        <p className='w-full poppins p-[1.5px] bg-[--nav] pl-[10px]  border-b-[1.5px] border-[--black]'>
                            ...
                            <input ref={resetRef} onChange={(e) => setPrice(e.target.value)} className='block w-full p-[4px] bg-transparent outline-none focus:pt-[10px] duration-[0.5s]' type="number" min={0} required name="price" id="price" />
                        </p>
                    </li>
                    <li>
                        <p className='w-full poppins p-[1.5px] bg-[--nav] pl-[10px]  border-b-[1.5px] border-[--black]'>
                            <label className=' text-[0.85rem]' htmlFor="stock">Total stock available<span className='text-red-600'>*</span></label>
                            <input ref={resetRef} onChange={(e) => setStock(e.target.value)} className='block w-full p-[4px] bg-transparent outline-none focus:pt-[10px] duration-[0.5s]' type="number" required min={1} name="stock" id="stock" />
                        </p>
                    </li>
                    <li>
                        <p className='w-full poppins p-[1.5px] bg-[--nav] pl-[10px]  border-b-[1.5px] border-[--black]'>
                            ...
                            <select ref={resetRef} required onChange={(e) => setCategory(e.target.value)} name="category" id="category" className='block w-full p-[4px] bg-transparent outline-none '>
