...
function SideBar({nav}) {
  ...
  return (
    <div className='z-[4] fixed h-[90vh] top-[4.5em] bg-[--nav]'>
        <div onPointerLeave={() => {
            if(nav) {
                return
            }
            ...
            setVisible(true)
            }}  className={`${visible ? "w-[300px]" : "w-[70px]"} h-full  sm:flex flex-col justify-center gap-[8em] shadow-md shadow-[--shadow] px-[1.5em] bg-[--nav]`}>
            ...
            className='h-full flex items-center'>
                <ul className=' flex flex-col gap-[5em] text-xl text-[--gray]'>
                    <li>
            ...
            className={` h-full flex flex-col justify-center gap-[8em] bg-white`}>
                <ul className='flex flex-col z-[1]'>
                    <li onClick={() => navigate("/")} className='poppins font-[semibold] text-[1.2em] text-[--gray] p-[.5em] cursor-pointer hover:bg-[--black] hover:text-[--nav] rounded-[5px]'>
                    ...
                    <li onClick={() => navigate("/menu")}  className='poppins font-[semibold] text-[1.2em] text-[--gray] p-[.5em] cursor-pointer hover:bg-[--black] hover:text-[--nav] rounded-[5px]'>
